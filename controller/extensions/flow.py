...
class Flow:
    ...
    def of(ip_pkt):
        ...
        src_port = inner_pkt.srcport if ip_pkt.protocol != ipv4.ICMP_PROTOCOL else None     # Sets 0 to ports
        dst_port = inner_pkt.dstport if ip_pkt.protocol != ipv4.ICMP_PROTOCOL else None     # (ofp_match default) since ICMP
